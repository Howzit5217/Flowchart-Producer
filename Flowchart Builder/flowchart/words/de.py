...
DE = {
    ...
    "r_by_hand": "Starten leuchtet von selbst auf, sobald der Entwurf funktioniert. Entwurf prüfen zeigt, was noch im Weg ist.",
    "r_hand_ready": "Bereit: Der Entwurf funktioniert als Programm. Drücke Starten, um es auszuprobieren.",
    "h_runnable": "Bereit: Das liest sich wie ein Programm, also leuchtet Starten.",
    ...
    "m_colors": "Farben", "m_more_shapes": "Weitere Formen",
