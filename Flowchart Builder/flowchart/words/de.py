...
DE = {
    ...
    "pick_shape": "Klicke eine Form an, um sie zu beschriften, zu verschieben oder zu verbinden. Ziehe über leeres Papier, um mehrere auszuwählen.",
    "many_head": "{n} Formen ausgewählt",
    "many_hint": "Ziehe eine davon, um alle zu verschieben. Umschalt-Klick auf eine Form nimmt sie dazu oder lässt sie weg.",
    "as_chart": "Diagramm",
    "untitled": "Ohne Titel",
    ...
    "d_rps": "Spielt Schere, Stein, Papier",
    "d_weekday": "Ermittelt den Wochentag eines Datums",
    "d_leap": "Prüft, ob ein Jahr ein Schaltjahr ist",
    "d_bank": "Führt ein Bankkonto mit Ein- und Auszahlungen",
    "d_loan": "Berechnet, wie lange die Tilgung eines Kredits dauert",
    ...
    "d_pay": "Berechnet den Lohn aus den Arbeitsstunden",
    "d_tip": "Berechnet das Trinkgeld und teilt die Rechnung",
    "d_vending": "Betreibt einen Automaten und gibt Wechselgeld",
    "d_change": "Zerlegt einen Betrag in Cent in Münzen",
    "d_shop": "Berechnet einen Preis mit Rabatt",
    "d_price": "Berechnet, was ein Einkauf kostet",
    "d_convert": "Rechnet Maßeinheiten um",
    "d_temps": "Rechnet Temperaturen von Celsius in Fahrenheit um",
    "d_temps_any": "Rechnet Temperaturen zwischen Celsius, Fahrenheit und Kelvin um",
    "d_primes": "Listet die Primzahlen bis zu einer Grenze auf",
    "d_prime": "Prüft, ob eine Zahl eine Primzahl ist",
    "d_fizz": "Spielt FizzBuzz",
    "d_gcd": "Findet den größten gemeinsamen Teiler zweier Zahlen",
    "d_fib": "Listet die Fibonacci-Zahlen auf",
    "d_factorial": "Berechnet die Fakultät einer Zahl",
    "d_reverse": "Schreibt die Ziffern einer Zahl rückwärts",
    "d_digits": "Zählt die Ziffern einer Zahl",
    "d_gradebook": "Benotet eine Klasse und fasst die Punkte zusammen",
    "d_grades": "Macht aus Punkten eine Note",
    "d_votes": "Zählt die Stimmen und nennt den Sieger",
    "d_quiz": "Stellt Quizfragen und zählt die Punkte",
    "d_login": "Fragt nach einem Passwort",
    "d_guess": "Ein Zahlenratespiel",
    "d_vowel": "Prüft, ob ein Buchstabe ein Vokal ist",
    "d_stars": "Zeichnet ein Dreieck aus Sternen",
    "d_grid": "Zeigt eine Einmaleins-Tafel",
    "d_table": "Zeigt eine Einmaleinsreihe",
    "d_minmax": "Findet die kleinste und die größte Zahl",
    "d_biggest": "Findet die größte Zahl",
    "d_scores": "Fasst eine Reihe von Punktzahlen zusammen",
    "d_average": "Berechnet einen Durchschnitt",
    "d_sumevens": "Addiert die geraden Zahlen von {a} bis {b}",
    "d_sumevens_any": "Addiert die geraden Zahlen",
    "d_oddeven": "Prüft, ob eine Zahl gerade oder ungerade ist",
    "d_swap": "Tauscht zwei Werte",
    "d_area": "Berechnet die Fläche eines Rechtecks",
    "d_menu": "Bietet ein Menü zur Auswahl",
    "d_down_n": "Zählt von {n} rückwärts",
    "d_down": "Zählt von einer Zahl rückwärts",
    "d_in_range": "Fragt so lange, bis die Antwort im Bereich liegt",
    "d_sum": "Addiert die Zahlen von {a} bis {b}",
    "d_sum_any": "Bildet eine laufende Summe",
    "d_count": "Zählt von {a} bis {b}",
    "d_add": "Addiert zwei Zahlen",
    "d_greet": "Fragt nach einem Namen und grüßt",
    "d_checks": "Prüft, ob {cond}",
    "d_while": "Wiederholt, solange {cond}",
    "d_until": "Wiederholt, bis {cond}",
    "d_repeats": "Wiederholt für {v} von {a} bis {b}",
    "d_uses": "Ruft {names} auf",
    "d_asks": "Fragt nach {what}",
    "d_asks_shows": "Fragt nach {what} und zeigt das Ergebnis",
    "d_one": "eine Zahl",
    "d_two": "zwei Zahlen",
    "d_three": "drei Zahlen",
    "d_numbers": "{n} Zahlen",
