...
EN = {
    ...
    "pick_shape": "Click a shape to give it words, move it, or join it to another. To select several, Shift+drag across empty paper, or choose Select at the foot of the page.",
