...
EN = {
    ...
    "pick_shape": "Click a shape to give it words, move it, or join it to another. Drag across empty paper to select several.",
    "many_head": "{n} shapes selected",
    "many_hint": "Drag any one of them to move them all. Shift-click a shape to add it or leave it out.",
    "as_chart": "Chart",
    "untitled": "Untitled",
    ...
    "d_rps": "Plays rock, paper, scissors",
    "d_weekday": "Works out the day of the week for a date",
    ...
    "d_change": "Breaks an amount of cents into coins",
    "d_shop": "Works out a price with a discount",
    "d_price": "Works out what a purchase costs",
    "d_convert": "Converts between units of measure",
    "d_temps": "Converts temperatures from Celsius to Fahrenheit",
    "d_temps_any": "Converts temperatures between Celsius, Fahrenheit and Kelvin",
    "d_primes": "Lists the prime numbers up to a limit",
    "d_prime": "Checks whether a number is prime",
    "d_fizz": "Plays FizzBuzz",
    "d_gcd": "Finds the greatest common factor of two numbers",
    "d_fib": "Lists the Fibonacci numbers",
    "d_factorial": "Works out the factorial of a number",
    "d_reverse": "Writes a number's digits backwards",
    "d_digits": "Counts the digits in a number",
    "d_gradebook": "Grades a class and sums up the scores",
    "d_grades": "Turns a score into a letter grade",
    "d_votes": "Counts the votes and names the winner",
    "d_quiz": "Asks quiz questions and keeps score",
    "d_login": "Asks for a password",
    "d_guess": "A number guessing game",
    "d_vowel": "Checks whether a letter is a vowel",
    "d_stars": "Draws a triangle of stars",
    "d_grid": "Shows a multiplication grid",
    "d_table": "Shows a times table",
    "d_minmax": "Finds the lowest and highest numbers",
    "d_biggest": "Finds the biggest number",
    "d_scores": "Sums up a set of scores",
    "d_average": "Works out an average",
    "d_sumevens": "Adds up the even numbers from {a} to {b}",
    "d_sumevens_any": "Adds up the even numbers",
    "d_oddeven": "Checks whether a number is odd or even",
    "d_swap": "Swaps two values",
    "d_area": "Works out the area of a rectangle",
    "d_menu": "Offers a menu of choices",
    "d_down_n": "Counts down from {n}",
    "d_down": "Counts down from a number",
    "d_in_range": "Keeps asking until the answer is in range",
    "d_sum": "Adds up the numbers from {a} to {b}",
    "d_sum_any": "Keeps a running total",
    "d_count": "Counts from {a} to {b}",
    "d_add": "Adds two numbers",
    "d_greet": "Asks for a name and says hello",
    "d_checks": "Checks whether {cond}",
    "d_while": "Repeats while {cond}",
    "d_until": "Repeats until {cond}",
    "d_repeats": "Repeats for {v} from {a} to {b}",
    "d_uses": "Calls {names}",
    "d_asks": "Asks for {what}",
    "d_asks_shows": "Asks for {what} and shows the result",
    "d_one": "a number",
    "d_two": "two numbers",
