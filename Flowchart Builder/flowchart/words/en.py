...
EN = {
    ...
    "pz_l2": "Make it work",
    "pz_l3": "Build it",
    "pz_check": "Check my answer",
    "pz_right": "Solved.",
    "pz_wrong": "Not right yet. Given {give} it should say {want} — it said {said}.",
    "pz_broke": "It stopped before it finished. Given {give} it should say {want}.",
