...
ES = {
    ...
    "pz_l3": "Constrúyelo",
    "pz_check": "Comprobar mi respuesta",
    "pz_right": "Resuelto.",
    "pz_wrong": "Todavía no. Con {give} debería decir {want} — dijo {said}.",
    "pz_broke": "Se paró antes de terminar. Con {give} debería decir {want}.",
