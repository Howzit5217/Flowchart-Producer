...
ES = {
    ...
    "z_coins_b": "132 peniques son 1 libra, 3 decenas y 2 peniques.",
    ...
    "z_grade_b": "50 aprueba. Ahora mismo 50 suspende.",
    "e_add": "Sumar dos números",
    "e_oddeven": "Par o impar",
    "e_guess": "Adivina el número",
    "e_highest": "El mayor hasta ahora",
    ...
    "e_bigger": "El mayor de dos",
    "e_sumevens": "Sumar los pares",
    "e_onetable": "Una tabla de multiplicar",
    "e_vowel": "Vocal o no",
    "e_leap": "Año bisiesto",
    "e_power": "Elevar a una potencia",
    "e_backwards": "Contar hacia atrás",
    "eg_l4": "Aún más difícil",
    "eg_l5": "Programas más grandes",
    "e_fizz": "Fizz y Buzz",
    "e_prime": "¿Es primo?",
    "e_gcd": "Máximo común divisor",
    "e_digits": "Cuántas cifras",
    "e_reverse": "El número al revés",
    "e_sumdigits": "Sumar las cifras",
    "e_grid": "Una cuadrícula de tablas",
    "e_triangle": "Números triangulares",
    ...
    "e_change": "Libras, decenas y peniques",
    ...
    "e_tables": "Tablas de multiplicar",
    "e_module": "Un módulo",
    "e_answers": "Una función que devuelve",
    "e_average": "Un promedio",
    "e_countdown": "Cuenta atrás",
    "e_password": "Una contraseña",
    ...
    "c_one": "En un solo archivo", "c_apart": "Un archivo por diagrama",
    "c_files_tip": "Si sale en un solo archivo o en uno por diagrama",
    "c_one_chart": "Este programa es un solo diagrama, así que sale en un archivo.",
