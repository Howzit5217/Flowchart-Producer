...
ES = {
    ...
    "pick_shape": "Haz clic en una forma para escribir en ella, moverla o unirla a otra. Arrastra sobre el papel vacío para seleccionar varias.",
    "many_head": "{n} formas seleccionadas",
    "many_hint": "Arrastra cualquiera de ellas para moverlas todas. Mayús+clic en una forma la añade o la quita.",
    "as_chart": "Diagrama",
    "untitled": "Sin título",
