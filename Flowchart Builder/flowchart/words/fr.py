...
FR = {
    ...
    "h_add_how": "Cliquez sur une forme ci-dessus pour l'ajouter sous celle en cours, ou faites-la glisser sur la feuille à l'endroit voulu.",
    ...
    "hp_what_in": "Qu'est-ce qu'on y met ?",
