...
FR = {
    ...
    "c_one": "Dans un seul fichier", "c_apart": "Un fichier par schéma",
    "c_files_tip": "Un seul fichier, ou un fichier par schéma",
    "c_one_chart": "Ce programme est un seul schéma : il tient dans un fichier.",
