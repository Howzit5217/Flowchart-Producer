...
FR = {
    ...
    "pick_shape": "Cliquez sur une forme pour y écrire, la déplacer ou la relier à une autre. Faites glisser sur la feuille vide pour en sélectionner plusieurs.",
    "many_head": "{n} formes sélectionnées",
    "many_hint": "Faites glisser l'une d'elles pour les déplacer toutes. Maj+clic sur une forme l'ajoute ou la retire.",
    ...
    "d_rps": "Joue à pierre, feuille, ciseaux",
    "d_weekday": "Trouve le jour de la semaine d'une date",
    "d_leap": "Vérifie si une année est bissextile",
    "d_bank": "Tient un compte bancaire, avec dépôts et retraits",
    "d_loan": "Calcule le temps qu'il faut pour rembourser un prêt",
    ...
    "d_pay": "Calcule le salaire selon les heures travaillées",
    "d_tip": "Calcule le pourboire et partage l'addition",
    "d_vending": "Fait marcher un distributeur et rend la monnaie",
    "d_change": "Décompose une somme en cents en pièces",
    "d_shop": "Calcule un prix avec une remise",
    "d_price": "Calcule ce que coûte un achat",
    "d_convert": "Convertit entre unités de mesure",
    "d_temps": "Convertit des températures de Celsius en Fahrenheit",
    "d_temps_any": "Convertit des températures entre Celsius, Fahrenheit et Kelvin",
    "d_primes": "Liste les nombres premiers jusqu'à une limite",
    "d_prime": "Vérifie si un nombre est premier",
    "d_fizz": "Joue à FizzBuzz",
    "d_gcd": "Trouve le plus grand commun diviseur de deux nombres",
    "d_fib": "Liste les nombres de Fibonacci",
    "d_factorial": "Calcule la factorielle d'un nombre",
    "d_reverse": "Écrit les chiffres d'un nombre à l'envers",
    "d_digits": "Compte les chiffres d'un nombre",
    "d_gradebook": "Note une classe et résume les résultats",
    "d_grades": "Transforme un score en lettre",
    "d_votes": "Compte les votes et désigne le gagnant",
    "d_quiz": "Pose des questions et compte les points",
    "d_login": "Demande un mot de passe",
    "d_guess": "Un jeu pour deviner un nombre",
    "d_vowel": "Vérifie si une lettre est une voyelle",
    "d_stars": "Dessine un triangle d'étoiles",
    "d_grid": "Affiche une grille de multiplication",
    "d_table": "Affiche une table de multiplication",
    "d_minmax": "Trouve le plus petit et le plus grand nombre",
    "d_biggest": "Trouve le plus grand nombre",
    "d_scores": "Résume une série de scores",
    "d_average": "Calcule une moyenne",
    "d_sumevens": "Additionne les nombres pairs de {a} à {b}",
    "d_sumevens_any": "Additionne les nombres pairs",
    "d_oddeven": "Vérifie si un nombre est pair ou impair",
    "d_swap": "Échange deux valeurs",
    "d_area": "Calcule l'aire d'un rectangle",
    "d_menu": "Propose un menu de choix",
    "d_down_n": "Compte à rebours depuis {n}",
    "d_down": "Compte à rebours depuis un nombre",
    "d_in_range": "Redemande jusqu'à ce que la réponse soit dans l'intervalle",
    "d_sum": "Additionne les nombres de {a} à {b}",
    "d_sum_any": "Tient un total cumulé",
    "d_count": "Compte de {a} à {b}",
    "d_add": "Additionne deux nombres",
    "d_greet": "Demande un nom et dit bonjour",
    "d_checks": "Vérifie si {cond}",
    "d_while": "Répète tant que {cond}",
    "d_until": "Répète jusqu'à ce que {cond}",
    "d_repeats": "Répète pour {v} de {a} à {b}",
    "d_uses": "Appelle {names}",
    "d_asks": "Demande {what}",
    "d_asks_shows": "Demande {what} et affiche le résultat",
    "d_one": "un nombre",
    "d_two": "deux nombres",
