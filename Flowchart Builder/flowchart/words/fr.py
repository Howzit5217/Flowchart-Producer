...
FR = {
    ...
    "pz_l3": "Construis-le",
    "pz_check": "Vérifier ma réponse",
    "pz_right": "Résolu.",
    "pz_wrong": "Pas encore. Avec {give} il devrait dire {want} — il a dit {said}.",
    "pz_broke": "Il s’est arrêté avant la fin. Avec {give} il devrait dire {want}.",
