...
FR = {
    ...
    "r_by_hand": "Lancer s’allume tout seul dès que le schéma fonctionne. Vérifier le schéma montre ce qui bloque encore.",
    "r_hand_ready": "Prêt : le schéma fonctionne comme un programme. Appuyez sur Lancer pour l’essayer.",
    "h_runnable": "Prêt : cela se lit comme un programme, donc Lancer est allumé.",
    ...
    "m_colors": "Couleurs", "m_more_shapes": "Autres formes",
